...
public class GatewayRouteService extends ServiceImpl<GatewayRouteMapper, GatewayRoute> implements IGatewayRouteService{
    ...
    public boolean overload() {
        ...
        for (GatewayRoute s :gatewayRoutes){
            gatewayRouteCache.put(s.getRouteId(), gatewayRouteToRouteDefinition(s));
            System.out.println(s.getRouteId()+"+"+gatewayRouteToRouteDefinition(s));
        }
